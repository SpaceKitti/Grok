...
- **cmhd:** mode="cmhd" drops Helmholtz; momentum keeps nabla p (spectral -ik p / rho). Not a WENO shock capture. Continuity + Russell p stay (gamma=5/3). A pressure bump seeds nonzero div u. mode="mhd" still Qin-projects. No pin/floor. No CFL rewrite yet.
