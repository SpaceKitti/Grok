...
- **cmhd:** `mode="cmhd"` (alias `"compressible"`) advects a density tracer via ∂t ρ + ∇·(ρu)=0. Helmholtz stays ON: this is a tracer, not acoustics. Uniform ρ=1 leftover is roundoff. `mode="mhd"` unchanged.
